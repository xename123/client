...
// const NavigationBlock: React.FC<NavigationProps> = ({ user }) => {
...
//       </div>
//       <swiper-container navigation="true" space-between="30" slides-per-view={window.innerWidth > 700 ? "3" : window.innerWidth > 450 ? "2" : "1"} >
  ...
  return (
    <div className={s.navigation}>
      ...
      <Swiper
        navigation={true}
        spaceBetween={30}
        slidesPerView={window.innerWidth > 700 ? 3 : window.innerWidth > 450 ? 2 : 1}
      >
        {cocktails.map((cocktail) => (
